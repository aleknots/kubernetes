#!/bin/bash
# Exposes public site through Kong Proxy.
# Usage: bash scripts/port-forward-site.sh [local_port]
...
main() {
    log_info "Starting port-forward for public site..."
    echo ""
    ...
    echo ""
    echo "Public Site: http://localhost:$LOCAL_PORT/site"
    echo ""
